...
以下两种方式购买 Alpha 代币，交易量交易量自动翻倍，每天多1分：

- 购买 BSC Alpha 代币
- 在任何链中通过限价购买 Alpha 代币
- 以上两种方式不可叠加翻倍
...
- 滑点设置 0.1%
- 网络费用选择“正常”
- YouTube 视频示例以500U/次刷分，刷一次的磨损约 2U，即约 0.4%
- 自己实际测试
...
- 如果能达到 1000U 网络费用 0.16U，磨损约为 0.02%
    ...
    - 每天获得积分为 2 + 14 = 16
    - 刷到 240 分需要 8192 * 0.02% \* 15 ≈ 25U，那这样的可行性还是比较可观的
