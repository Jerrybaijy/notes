...
```
提示词：将 associate 作为核心词，模仿下面 polis 的格式，对与 associate 相关的词进行树形图归档；不需要词性分支，但在中文释义前添加词性的缩写；不需要短语词组。最后在代码块里给我源码。
polis（n. 城邦；政治）
├─ polity（n. 政体）
├─ policy（n. 政策）
├─ politic（adj. 精明的）
...
| 词性变化 | 前缀  | 含义 | 示例  |
| :---: | :---: | :---: | :---: |
|  v. → n. | -or<br>-er<br>-ar | ...的人或物 | work → workor 工人<br>cook → cooker 炊具<br>beg → beggar 乞丐 |
|  v. → n. | -or<br>-ess | 男...人<br>女...人 | act → actor 男演员<br>act → actress 女演员 |
|  n. → n. | -ian | ...的专家 | technic → technician 技术员<br>politician 政客<br>musician 音乐家 |
|  n. → n. | -ist | ...学家<br>演奏家<br>职业 | physic → physicist 物理学家<br>piano → pianist 钢琴家<br>musician 音乐家 |
|  n. → n. | -an | ...地方的人 | America 美国 → American 美国人 |
|  v. → n. | -ance<br>-ence | 动词原义或引申 | appear → appearance 外表<br>prefer → preference 偏好 |
|  v. → n. | -ion<br>-ation | ...的行为（状态） | prevent → prevention 防止<br>imagine → imagination 想象 |
|  v. → n. | -ance<br>-ence | 动词原义或引申 | appear → appearance 外表<br>prefer → preference 偏好 |
