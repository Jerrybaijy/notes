...
当重做系统以后，电脑中原来的仓库会由于**Git 的安全机制（safe.directory）** 导致报错：

```bash
$ git branch
fatal: detected dubious ownership in repository at 'D:/projects/my-project'
'D:/projects/my-project' is owned by:
        (inconvertible) (S-1-5-21-542557873-3206750527-1925527139-1001)
but the current user is:
        PC-JERRY-2/jerry (S-1-5-21-1609793906-3874020359-1606072782-1001)
